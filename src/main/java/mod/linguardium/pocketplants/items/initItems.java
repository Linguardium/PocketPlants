...
public class initItems {
    ...
    public static final PocketTerrarium WATER_TERRARIUM = new PocketTerrarium(TERRARIUM_BLOCK, new Item.Settings().group(null).maxCount(1));
    public static final PocketTerrarium CROP_TERRARIUM = new PocketTerrarium(TERRARIUM_BLOCK, new Item.Settings().group(null).maxCount(1));
    public static final PocketTerrarium FLOWER_TERRARIUM = new PocketTerrarium(TERRARIUM_BLOCK, new Item.Settings().group(null).maxCount(1));
    ...
    public static void initItems() {
        ...
        PocketTerrarium.registerTallPlant(TallFlowerBlock.class);
        PocketTerrarium.registerTallPlant(SugarCaneBlock.class);
        PocketTerrarium.registerTallPlant(CactusBlock.class);
